const MACRONAME = "Update_ItemMacro.js"
/******************************************************************************
 * Macro to find all actors who have an Item that matches an item selected on 
 * the current actor and replaces the ItemMacro with the one found on the 
 * current item.
 * 
 * This macro should be run from the hotbar with a (one!) token of interest 
 * selected in a scene.
 *
 * 05/05/22 0.1 Creation
 *****************************************************************************/
let cnt = 0;
let cntFound = 0;
let itemFound = null;
