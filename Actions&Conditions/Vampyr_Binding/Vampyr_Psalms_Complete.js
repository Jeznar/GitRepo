const MACRONAME = "Vampyr_Psalms_Complete.0.1.js"
/*********1*********2*********3*********4*********5*********6*********7*********8*********9*********0*********1*********2*********3*
 * When the readings are complete, several effects from the ritual are terminated.
 * 
 * Speed penalty - Psalm 1: Bone
 * HP Drain - Psalm 2: Blood
 * Fear effect - Psalm 4: Fear
 * Choking effect - Psalm 5: Amber.1
 * Mist shrouding the ritual lights - Psalm 6: Amber.2
 * Random movement - Psam 7: Amber.3
 * 
 * 01/09/23 0.1 Creation of Macro
 *********1*********2*********3*********4*********5*********6*********7*********8*********9*********0*********1*********2*********3*/
 ...
 * Random movement - Psam 7: Amber.3
*********1*********2*********3*********4*********5*********6*********7*********8*********9*********0*********1*********2*********3*/
async function psalmsComplete(options = {}) {
    ...
    //--------------------------------------------------------------------------------------------------
    //  Loop through lanterns, deleting the attached walls
    //
    ...
    // 2. Loop through the lanterns, getting rid of attached walls
    ...
    // 6. Post Results
    // 
    msg = `The mists thin slightly, reducing their grip on the world as an Aspect of Vampyr appears within the salt circle.`
    postResults(msg)
    return
}
/*********1*********2*********3*********4*********5*********6*********7*********8*********9*********0*********1*********2*********3*
