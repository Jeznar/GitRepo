const MACRONAME = "Armor_of_Akroma.0.1.js"
 ...
 * 
 *   If a creature hits you with a melee attack while you have these hit points, the creature takes 5 radiant damage.
 * 
 ...
 *   radiant damage increase by 5 for each slot.
 * 
 ...
 * 11/18/23 0.2 Modification of Armor_of_Agathys.0.1.js to do Radiant instead of Cold damage
 *********1*********2*********3*********4*********5*********6*********7*********8*********9*********0*********1*********2*********3*/
...
//
const EFFECT_NAME = "Armor of Akroma"
const TEMP_ITEM = "Armor of Akroma Damage"
...
async function doOnUse(options = {}) {
    ...
    //
    ceDesc = `While Temp HP Remains, ${args[0].damageTotal} radiant damage manually applied to melee attackers`
...
async function doOn(options = {}) {
    ...
    itemUpdate = {
        data: { 
            ...
            damage: {
                parts: [[`${args[1]*5}[radiant]`,'radiant']]
            }
        },  
    }
    //-------------------------------------------------------------------------------------------------------------------------------
...
async function doOff(options = {}) {
    ...
    let title = `Armor of Akroma Fades`
