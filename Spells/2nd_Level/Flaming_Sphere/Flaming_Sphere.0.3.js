const MACRONAME = "Flaming_Sphere.0.3.js"
/*****************************************************************************************
...
const MINION_UNIQUE_NAME = `Flaming_Sphere-${aToken.name}`
 ...
 ***************************************************************************************/
 async function doOnUse() {
    ...
    jez.log(`OnUse ==> Summon the ${MINION_NAME} to act as a placeholder for the VFX at ${x},${y}`)
    ...
    jez.log(`OnUse ==> Change summoned ${MINION_NAME} to a more unique name, ${MINION_UNIQUE_NAME}`)
    let updates = { _id: tToken.id, name: MINION_UNIQUE_NAME };
    jez.log(`OnUse ==> Target token information ${tToken.name}`, tToken, "updates to apply", updates);
 ...
 ***************************************************************************************************/
 async function findTokenByName(name) {
    ...
    jez.log(`-------------- Starting --- ${MACRONAME} ${FUNCNAME} name: ${name} ---------------`);
    let targetToken = ""
    //----------------------------------------------------------------------------------------------
