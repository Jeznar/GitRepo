const MACRONAME = "Crown_of_Madness"
/*****************************************************************************************
 ...
 ***************************************************************************************************/
 async function doOnUse() {
    ...
    let effectData = [{
        changes: [
            { key: "macro.execute", mode: CUSTOM, value: "Crown_of_Madness_Helper", priority: 20 }
        ],
        origin: aToken.uuid,
        flags: { dae: { itemData: aItem, macroRepeat: "startEveryTurn", token: tToken.uuid } },
        disabled: false,
