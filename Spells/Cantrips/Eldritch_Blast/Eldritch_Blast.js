const MACRONAME = "Eldritch_Blast.0.2"
/***************************************************************************************** 
 * 01/06/21 0.1 Creation of Macro
 ...
 ***************************************************************************************************/
/***************************************************************************************************
 * Check the setup of things.  Return true if things are ok, otherwise false
 ***************************************************************************************************/
function preCheck() {
    //----------------------------------------------------------------------------------------------
...
async function doOnUse() {
    ...
    const PREFIX = "EldritchBlast_01_Regular_"
    let color = "";
    switch (Math.floor(Math.random() * 8)) {
        ...
        case 6: color = "Rainbow";      break;
        case 7: color = "Yellow";       break;
        default: ui.notifications.error("Value was not an integer between 0 and 8 (inclusive)")
    }
