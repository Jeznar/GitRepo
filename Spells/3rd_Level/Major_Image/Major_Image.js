const MACRONAME = "Major_Image.0.1.js"
/*********1*********2*********3*********4*********5*********6*********7*********8*********9*********0
 ...
 * 
 * 12/16/22 0.1 Creation of Macro from Silent_Image
 *********1*********2*********3*********4*********5*********6*********7*********8*********9*********/
...
async function doOnUse() {
  ...
  //
  let summonedID = await summonMajorImage()
  ...
  //
  msg = `${aToken.name} creates a major image.<br><br>
    See:&nbsp;<a href="https://www.dndbeyond.com/spells/major-image" target="_blank" rel="noopener">
 ...
 ***************************************************************************************************/
async function summonMajorImage() {
  const FUNCNAME = "summonMajorImage()";
  const FNAME = FUNCNAME.split("(")[0]
  if (TL === 1) jez.trace(`--- Starting --- ${MACRONAME} ${FNAME} ---`);
  //-----------------------------------------------------------------------------------------------
  //
  let argObj = {
    ...
    width: 4,                           // Width of token to be summoned
    traceLvl: TL
  }
  //--------------------------------------------------------------------------------------------------
