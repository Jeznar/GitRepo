const MACRONAME = "Cauterizing_Flame_Extinguish.0.1.js"
const TL = 0;                               // Trace Level for this macro
/*********1*********2*********3*********4*********5*********6*********7*********8*********9*********0*********1*********2*********3*
 * This macro deletes the using token.
 * 
 * 11/14/22 0.1 Creation of Macro
 *********1*********2*********3*********4*********5*********6*********7*********8*********9*********0*********1*********2*********3*/
...
async function doOnUse(options = {}) {
    ...
    let sphereId = L_ARG.tokenId
    warpgate.dismiss(sphereId, sceneId)
    //-------------------------------------------------------------------------------------------------------------------------------
    // 
    postResults(`${aToken.name} blinks out of existance.`)
