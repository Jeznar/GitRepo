const MACRONAME = "Battlemaster_Manuever.0.1"
/*****************************************************************************************
 * Derived from Divine Smite
 *
...
await new MidiQOL.DamageOnlyWorkflow(aActor, aToken, damageRoll.total, DAMAGE_TYPE, [tToken], damageRoll,
    { flavor: `(${CONFIG.DND5E.damageTypes[DAMAGE_TYPE]})`, itemCardId: LASTARG.itemCardId, itemData: aItem, useOther: false });
//---------------------------------------------------------------------------------------
